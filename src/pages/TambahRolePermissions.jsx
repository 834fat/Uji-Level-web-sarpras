...
const AddRolePermissionsForm = ({ onSubmit }) => {
        ...
        <div className="flex">
            ...
            <div className="flex-1 p-4">
                <div className="bg-[#F5F5F5] rounded-lg shadow-md p-4 relative">
                    <h1 className="text-xl font-semibold mb-4">Tambah Role Permissions</h1>
                ...
                <div className="flex justify-center items-center h-screen pb-[150px]">
                    <div className="bg-[#F5F5F5] rounded-lg shadow-md p-6">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label htmlFor="pageName" className="block text-sm font-medium text-gray-700">Page Name</label>
                                <input type="text" id="pageName" name="pageName" value={formData.pageName} onChange={handleChange} className="mt-1 block w-full rounded-md border border-black shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="actionName" className="block text-sm font-medium text-gray-700">Action Name</label>
                                <input type="text" id="actionName" name="actionName" value={formData.actionName} onChange={handleChange} className="mt-1 block w-full rounded-md border border-black shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                            </div>
...
export default AddRolePermissionsForm;
